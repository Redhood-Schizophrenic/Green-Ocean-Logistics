...
export const navLinks = [
	...
	},
	{
		...
		subItems: [
			...
			{ label: "Weighment Slip Request", href: '/client/cfs/services/weighment-slip', access: 'Client', icon: Scale, },
			{ label: "Special Equipment Request", href: '/client/cfs/services/special-equipment', access: 'Client', icon: LayoutGrid, },
			{ label: "Container Grounding", href: '/client/cfs/services/container-grounding', access: 'Client', icon: ArrowDown, },
			{ label: "Container Staging Request", href: '/client/cfs/services/container-staging', access: 'Client', icon: Boxes, },
			{ label: "Re-Scanning Request", href: '/client/cfs/services/rescan', access: 'Client', icon: Scan, },
			{ label: "Cheque Acceptance", href: '/client/cfs/services/cheque', access: 'Client', icon: CreditCard, },
			{ label: "Tax Invoice Request", href: '/client/cfs/services/tax-invoice', access: 'Client', icon: Receipt, },
			{ label: "Job Order Update Request", href: '/client/cfs/services/job-order', access: 'Client', icon: FileText, },
		]
	},
