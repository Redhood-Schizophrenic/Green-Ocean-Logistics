...
import { LogInIcon, ArrowUpRight, Users } from "lucide-react";
	...
	return (
		<header>
			...
			>
					...
					<div className="flex items-center justify-center w-full">
						<div className="flex items-center justify-between w-[80%]">
							...
							<div className="flex items-center gap-3">
								...
								/>
								<Button title={'Login'} icon={<LogInIcon />} iconPosition="right" className="rounded-md" onClick={() => router.push('/login')} />
							</div>
						</div>
					</div>
				</div>
				...
				{/* Services List */}
				<div className={`bg-[var(--accent)] py-3 px-4 rounded-xl mx-auto max-w-3xl flex justify-between items-center shadow-md border border-gray-200 opacity-100`}>
