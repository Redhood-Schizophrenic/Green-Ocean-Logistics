...
import { JobUpdateRequest } from '@/constants/requests';
import Input from '@/components/ui/Input';
import NewRequests from '../../../../components/NewRequests';

const MobileJobOrder = () => {

  const [searchQuery, setSearchQuery] = useState('');

  const filteredRequests = JobUpdateRequest.filter(request => {
    const matchesSearch =
